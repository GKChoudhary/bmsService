...
import com.rank.futuregenerali.service.EmployeeCallProficiencyService;
...
public class EmployeeCallProficiencyServiceImpl implements EmployeeCallProficiencyService {
    ...
    public List<EmployeeCallProficiency> findEmployeeCallProficiencyByPrimarySegment(String segment) {
        List<EmployeeCallProficiency> employeeCallProficiencyList = employeeCallProficiencyDao.createQuerySingleResult(
                "from EmployeeCallProficiency as model where model.segmentP=?", segment);
    ...
    public List<EmployeeCallProficiency> findEmployeeCallProficiencyBySecondarySegment(String segment) {
        ...
        List<EmployeeCallProficiency> employeeCallProficiencyList = employeeCallProficiencyDao.createQuerySingleResult(
                "from EmployeeCallProficiency as model where model.segmentS=?", segment);
    ...
    public List<EmployeeCallProficiency> findEmployeeCallProficiencyByPrimaryService(String service) {
        ...
        List<EmployeeCallProficiency> employeeCallProficiencyList = employeeCallProficiencyDao.createQuerySingleResult(
                "from EmployeeCallProficiency as model where model.serviceP=?", service);
    ...
    public List<EmployeeCallProficiency> findEmployeeCallProficiencyBySecondaryService(String service) {
        ...
        List<EmployeeCallProficiency> employeeCallProficiencyList = employeeCallProficiencyDao.createQuerySingleResult(
                "from EmployeeCallProficiency as model where model.serviceS=?", service);
    ...
    public List<EmployeeCallProficiency> findEmployeeCallProficiencyByPrimaryLanguage(String language) {
        ...
        List<EmployeeCallProficiency> employeeCallProficiencyList = employeeCallProficiencyDao.createQuerySingleResult(
                "from EmployeeCallProficiency as model where model.languageP=?", language);
    ...
    public List<EmployeeCallProficiency> findEmployeeCallProficiencyBySecondaryLanguage(String language) {
        ...
        List<EmployeeCallProficiency> employeeCallProficiencyList = employeeCallProficiencyDao.createQuerySingleResult(
                "from EmployeeCallProficiency as model where model.languageS=?", language);
    ...
    *//**
     * Method to delete the data actually from the Database.
     *
     * @param employeeCallProficiency
     *//*
    @Transactional
    @Override
    ...
    *//**
     * Find all the related CallProficiency Entities for the input Employee
     * Master
     *
     * @param employeeMst of EmployeeMst class
     * @return List
     *//*
    @Override
